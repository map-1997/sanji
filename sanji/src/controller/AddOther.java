...
@WebServlet("/AddOther")
public class AddOther extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Log l1 = new Log(0, fidd, "查询指定id下的所有地区", new Timestamp(System.currentTimeMillis()));
		Log l2 = new Log(0, fidd, "添加地区", new Timestamp(System.currentTimeMillis()));
		
		String str = "[\u4e00-\u9fa5]{1,}[市|区|县]";
		...
		List<Area> list = s.selectCityArea(fid,l1);
